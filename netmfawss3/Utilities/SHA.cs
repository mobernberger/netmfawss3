// This is a forked Class from Elze Kool (kooldevelopment.nl), which provided the whole class to me.
// For size reasons I deleted all algorithms I do not need.
...
namespace netmfawss3.Utilities
{
    ...
    public static class SHA
    {
        ...
        private static readonly uint[] sha256_k = new uint[]
        {
